...
L48C3:	.byte	$6B                             ; 48C3 6B                       k
	...
	eor     L5048                           ; 4913 4D 48 50                 MHP
	pha                                     ; 4916 48                       H
	.byte   $53                             ; 4917 53                       S
	pha                                     ; 4918 48                       H
	eor     L5D48,y                         ; 4919 59 48 5D                 YH]
	pha                                     ; 491C 48                       H
	.byte   $64                             ; 491D 64                       d
	pha                                     ; 491E 48                       H
	ror     a                               ; 491F 6A                       j
...
L4FEA:  lda     $A0                             ; 4FEA A5 A0                    ..
	...
	eor     #$01                            ; 4FF2 49 01                    I.
	beq     L4FF9                           ; 4FF4 F0 03                    ..
	jmp     L5015                           ; 4FF6 4C 15 50                 L.P

; ----------------------------------------------------------------------------
L4FF9:  lda     L4FBB                           ; 4FF9 AD BB 4F                 ..O
	eor     #$0A                            ; 4FFC 49 0A                    I.
	beq     L5003                           ; 4FFE F0 03                    ..
	jmp     L5010                           ; 5000 4C 10 50                 L.P

; ----------------------------------------------------------------------------
L5003:  ldy     #$00                            ; 5003 A0 00                    ..
...
; ----------------------------------------------------------------------------
L5010:  lda     #$00                            ; 5010 A9 00                    ..
	sta     $A0                             ; 5012 85 A0                    ..
	rts                                     ; 5014 60                       `

; ----------------------------------------------------------------------------
L5015:  lda     L464F                           ; 5015 AD 4F 46                 .OF
	beq     L501D                           ; 5018 F0 03                    ..
	jmp     L5085                           ; 501A 4C 85 50                 L.P

; ----------------------------------------------------------------------------
L501D:  lda     L4FBB                           ; 501D AD BB 4F                 ..O
L5020:  and     #$7F                            ; 5020 29 7F                    ).
	...
	bcc     L5036                           ; 5031 90 03                    ..
	jmp     L5040                           ; 5033 4C 40 50                 L@P
...
L50A4:  clc                                     ; 50A4 18                       .
	...
	sta     ($AE),y                         ; 50B9 91 AE                    ..
	clc                                     ; 50BB 18                       .
	lda     L4FC1                           ; 50BC AD C1 4F                 ..O
	adc     L4FBB                           ; 50BF 6D BB 4F                 m.O
	sta     L4FC1                           ; 50C2 8D C1 4F                 ..O
...
L5277:	stx     L526C                           ; 5277 8E 6C 52                 .lR
	...
	lda     L526B                           ; 527D AD 6B 52                 .kR
	sta     $AE                             ; 5280 85 AE                    ..
	lda     L526C                           ; 5282 AD 6C 52                 .lR
	sta     $AF                             ; 5285 85 AF                    ..
	ldy     #$00                            ; 5287 A0 00                    ..
	lda     ($AE),y                         ; 5289 B1 AE                    ..
...
L5394:  jmp     L5397                           ; 5394 4C 97 53                 L.S

; ----------------------------------------------------------------------------
L5397:  ldy     #$00                            ; 5397 A0 00                    ..
	sty     L5392                           ; 5399 8C 92 53                 ..S
	jsr     L4FC5                           ; 539C 20 C5 4F                  .O
	lda     $A0                             ; 539F A5 A0                    ..
	...
	eor     #$04                            ; 53AD 49 04                    I.
	beq     L53B4                           ; 53AF F0 03                    ..
	jmp     L53BE                           ; 53B1 4C BE 53                 L.S

; ----------------------------------------------------------------------------
L53B4:  ldx     #$B1                            ; 53B4 A2 B1                    ..
	lda     #$6A                            ; 53B6 A9 6A                    .j
	jsr     L52E1                           ; 53B8 20 E1 52                  .R
...
L5421:  lda     L5393                           ; 5421 AD 93 53                 ..S
	...
	ldx     #$B1                            ; 542B A2 B1                    ..
	lda     #$6A                            ; 542D A9 6A                    .j
	jsr     L52E1                           ; 542F 20 E1 52                  .R
	jmp     L5449                           ; 5432 4C 49 54                 LIT

; ----------------------------------------------------------------------------
L5435:  ldy     #$01                            ; 5435 A0 01                    ..
	sty     L5392                           ; 5437 8C 92 53                 ..S
	lda     $022A                           ; 543A AD 2A 02                 .*.
	beq     L5442                           ; 543D F0 03                    ..
	.byte   $4C                             ; 543F 4C                       L
	.byte   $49                             ; 5440 49                       I
L5441:  .byte   $54                             ; 5441 54                       T
L5442:  ldx     #$B1                            ; 5442 A2 B1                    ..
	lda     #$6A                            ; 5444 A9 6A                    .j
	jsr     L52E1                           ; 5446 20 E1 52                  .R
L5449:  jmp     L545B                           ; 5449 4C 5B 54                 L[T

; ----------------------------------------------------------------------------
L544C:  lda     $022A                           ; 544C AD 2A 02                 .*.
	beq     L5454                           ; 544F F0 03                    ..
	jmp     L545B                           ; 5451 4C 5B 54                 L[T

; ----------------------------------------------------------------------------
L5454:  .byte   $A2                             ; 5454 A2                       .
L5455:  lda     ($A9),y                         ; 5455 B1 A9                    ..
	ror     a                               ; 5457 6A                       j
	jsr     L52E1                           ; 5458 20 E1 52                  .R
L545B:  lda     L5392                           ; 545B AD 92 53                 ..S
	sta     $A0                             ; 545E 85 A0                    ..
	rts                                     ; 5460 60                       `

; ----------------------------------------------------------------------------
L5461:  jmp     L5464                           ; 5461 4C 64 54                 LdT

; ----------------------------------------------------------------------------
L5464:  lda     L4651                           ; 5464 AD 51 46                 .QF
	beq     L546C                           ; 5467 F0 03                    ..
	jmp     L5471                           ; 5469 4C 71 54                 LqT

; ----------------------------------------------------------------------------
L546C:  lda     #$00                            ; 546C A9 00                    ..
	sta     $A0                             ; 546E 85 A0                    ..
	rts                                     ; 5470 60                       `

; ----------------------------------------------------------------------------
L5471:  clc                                     ; 5471 18                       .
	lda     L531D                           ; 5472 AD 1D 53                 ..S
	adc     #$01                            ; 5475 69 01                    i.
	sta     $AE                             ; 5477 85 AE                    ..
	lda     $B1C8                           ; 5479 AD C8 B1                 ...
	eor     $AE                             ; 547C 45 AE                    E.
	beq     L5483                           ; 547E F0 03                    ..
	jmp     L54E3                           ; 5480 4C E3 54                 L.T

; ----------------------------------------------------------------------------
L5483:  jsr     L537F                           ; 5483 20 7F 53                  .S
	...
	sta     $AE                             ; 5491 85 AE                    ..
	lda     $AE                             ; 5493 A5 AE                    ..
	bne     L549A                           ; 5495 D0 03                    ..
	jmp     L54B8                           ; 5497 4C B8 54                 L.T

; ----------------------------------------------------------------------------
L549A:  lda     #$B1                            ; 549A A9 B1                    ..
	sta     $A3                             ; 549C 85 A3                    ..
...
; ----------------------------------------------------------------------------
L552F:  jsr     L4FC5                           ; 552F 20 C5 4F                  .O
	lda     $A0                             ; 5532 A5 A0                    ..
...
L56F4:  lda     L5591                           ; 56F4 AD 91 55                 ..U
	...
	beq     L56FE                           ; 56F9 F0 03                    ..
	jmp     L5774                           ; 56FB 4C 74 57                 LtW

; ----------------------------------------------------------------------------
L56FE:  clc                                     ; 56FE 18                       .
	lda     L558C                           ; 56FF AD 8C 55                 ..U
	adc     #$01                            ; 5702 69 01                    i.
	sta     L558E                           ; 5704 8D 8E 55                 ..U
	lda     L558D                           ; 5707 AD 8D 55                 ..U
	adc     #$00                            ; 570A 69 00                    i.
	sta     L558F                           ; 570C 8D 8F 55                 ..U
	lda     L558E                           ; 570F AD 8E 55                 ..U
	sta     $AE                             ; 5712 85 AE                    ..
	lda     L558F                           ; 5714 AD 8F 55                 ..U
	sta     $AF                             ; 5717 85 AF                    ..
	lda     ($AE),y                         ; 5719 B1 AE                    ..
	sta     $A0                             ; 571B 85 A0                    ..
	clc                                     ; 571D 18                       .
	...
	sta     $A0                             ; 574D 85 A0                    ..
	clc                                     ; 574F 18                       .
	lda     L559E                           ; 5750 AD 9E 55                 ..U
	adc     L5594                           ; 5753 6D 94 55                 m.U
	sta     $A1                             ; 5756 85 A1                    ..
	lda     L559F                           ; 5758 AD 9F 55                 ..U
	adc     #$00                            ; 575B 69 00                    i.
	sta     $A2                             ; 575D 85 A2                    ..
	ldy     $A2                             ; 575F A4 A2                    ..
	ldx     $A1                             ; 5761 A6 A1                    ..
	...
	jsr     tohex
	clc                                     ; 5768 18                       .
	lda     L5594                           ; 5769 AD 94 55                 ..U
	adc     #$02                            ; 576C 69 02                    i.
	sta     L5594                           ; 576E 8D 94 55                 ..U
...
; ----------------------------------------------------------------------------
L5785:  lda     L558C                           ; 5785 AD 8C 55                 ..U
	sta     $AE                             ; 5788 85 AE                    ..
	lda     L558D                           ; 578A AD 8D 55                 ..U
	sta     $AF                             ; 578D 85 AF                    ..
	ldy     #$00                            ; 578F A0 00                    ..
	lda     ($AE),y                         ; 5791 B1 AE                    ..
...
L581B:  clc                                     ; 581B 18                       .
	lda     L5598                           ; 581C AD 98 55                 ..U
	adc     L5593                           ; 581F 6D 93 55                 m.U
	sta     $AE                             ; 5822 85 AE                    ..
	lda     L5599                           ; 5824 AD 99 55                 ..U
	adc     #$00                            ; 5827 69 00                    i.
	sta     $AF                             ; 5829 85 AF                    ..
	ldy     #$00                            ; 582B A0 00                    ..
	lda     ($AE),y                         ; 582D B1 AE                    ..
	...
	beq     L583C                           ; 5837 F0 03                    ..
	jmp     L5847                           ; 5839 4C 47 58                 LGX

; ----------------------------------------------------------------------------
L583C:  lda     L5595                           ; 583C AD 95 55                 ..U
...
sub_58F2:
	...
	lda     L58E7                           ; 5903 AD E7 58                 ..X
	sta     $AE                             ; 5906 85 AE                    ..
	lda     L58E8                           ; 5908 AD E8 58                 ..X
	sta     $AF                             ; 590B 85 AF                    ..
	dey                                     ; 590D 88                       .
	lda     ($AE),y                         ; 590E B1 AE                    ..
...
L591F:  clc                                     ; 591F 18                       .
	lda     L58E7                           ; 5920 AD E7 58                 ..X
	adc     L58ED                           ; 5923 6D ED 58                 m.X
	sta     $AE                             ; 5926 85 AE                    ..
	lda     L58E8                           ; 5928 AD E8 58                 ..X
	adc     #$00                            ; 592B 69 00                    i.
	sta     $AF                             ; 592D 85 AF                    ..
	ldy     #$00                            ; 592F A0 00                    ..
	lda     ($AE),y                         ; 5931 B1 AE                    ..
	...
	beq     L5940                           ; 593B F0 03                    ..
	jmp     L5A35                           ; 593D 4C 35 5A                 L5Z
...
L5940:  clc                                     ; 5940 18                       .
	...
	lda     L58E9                           ; 5950 AD E9 58                 ..X
	sta     $AE                             ; 5953 85 AE                    ..
	lda     L58EA                           ; 5955 AD EA 58                 ..X
	sta     $AF                             ; 5958 85 AF                    ..
...
L5A53:  lda     L58EB                           ; 5A53 AD EB 58                 ..X
	...
	sta     ($AE),y                         ; 5A82 91 AE                    ..
	clc                                     ; 5A84 18                       .
	lda     L4654                           ; 5A85 AD 54 46                 .TF
	adc     #$02                            ; 5A88 69 02                    i.
	sta     L4654                           ; 5A8A 8D 54 46                 .TF
...
L5A9A:  lda     L58EA                           ; 5A9A AD EA 58                 ..X
	...
	sta     L58EB                           ; 5AA3 8D EB 58                 ..X
	inc     L58E9                           ; 5AA6 EE E9 58                 ..X
	bne     L5AAE                           ; 5AA9 D0 03                    ..
	inc     L58EA                           ; 5AAB EE EA 58                 ..X
L5AAE:  lda     L58EB                           ; 5AAE AD EB 58                 ..X
	sta     $AE                             ; 5AB1 85 AE                    ..
	lda     L58EC                           ; 5AB3 AD EC 58                 ..X
	sta     $AF                             ; 5AB6 85 AF                    ..
	lda     $AF                             ; 5AB8 A5 AF                    ..
	pha                                     ; 5ABA 48                       H
	lda     $AE                             ; 5ABB A5 AE                    ..
...
L5B2A:  lda     L58EE                           ; 5B2A AD EE 58                 ..X
	...
	beq     L5B34                           ; 5B2F F0 03                    ..
	jmp     L5BC1                           ; 5B31 4C C1 5B                 L.[
...
L5B34:  clc                                     ; 5B34 18                       .
	...
	lda     L58E9                           ; 5B44 AD E9 58                 ..X
	sta     $AE                             ; 5B47 85 AE                    ..
	lda     L58EA                           ; 5B49 AD EA 58                 ..X
	sta     $AF                             ; 5B4C 85 AF                    ..
...
; ----------------------------------------------------------------------------
L5CFC:  jmp     L5CFF                           ; 5CFC 4C FF 5C                 L.\

; ----------------------------------------------------------------------------
L5CFF:  jmp     L5D04                           ; 5CFF 4C 04 5D                 L.]

; ----------------------------------------------------------------------------
	ora     ($43,x)                         ; 5D02 01 43                    .C
...
L5D11:  lda     L4650                           ; 5D11 AD 50 46                 .PF
	bne     L5D19                           ; 5D14 D0 03                    ..
	jmp     L5D1F                           ; 5D16 4C 1F 5D                 L.]

; ----------------------------------------------------------------------------
L5D19:  jsr     L5394                           ; 5D19 20 94 53                  .S
...
L5D40:  lda     $B148                           ; 5D40 AD 48 B1                 .H.
	eor     #$01                            ; 5D43 49 01                    I.
	beq     L5D4A                           ; 5D45 F0 03                    ..
	.byte   $4C                             ; 5D47 4C                       L
L5D48:  .byte   $5E                             ; 5D48 5E                       ^
	.byte   $5D                             ; 5D49 5D                       ]
L5D4A:  lda     #$00                            ; 5D4A A9 00                    ..
	sta     $A3                             ; 5D4C 85 A3                    ..
	lda     #$A1                            ; 5D4E A9 A1                    ..
	sta     $A4                             ; 5D50 85 A4                    ..
	ldy     #$5A                            ; 5D52 A0 5A                    .Z
...
L64D5:  lda     L63DB                           ; 64D5 AD DB 63                 ..c
	...
	cmp     #$18                            ; 6570 C9 18                    ..
	bcs     L6577                           ; 6572 B0 03                    ..
	.byte   $4C                             ; 6574 4C                       L
L6575:  .byte   $7A                             ; 6575 7A                       z
L6576:  .byte   $65                             ; 6576 65                       e
L6577:  jmp     L6580                           ; 6577 4C 80 65                 L.e

; ----------------------------------------------------------------------------
	inc     L63D6                           ; 657A EE D6 63                 ..c
...
; ----------------------------------------------------------------------------
L8020:  jmp     L8023                           ; 8020 4C 23 80                 L#.

; ----------------------------------------------------------------------------
L8023:  lda     #$00                            ; 8023 A9 00                    ..
	sta     $A3                             ; 8025 85 A3                    ..
	ldy     #$04                            ; 8027 A0 04                    ..
	ldx     #$47                            ; 8029 A2 47                    .G
	lda     #$4F                            ; 802B A9 4F                    .O
...
L8046:  pha                                     ; 8046 48                       H
L8047:  jmp     L804A                           ; 8047 4C 4A 80                 LJ.

; ----------------------------------------------------------------------------
L804A:  stx     L8046                           ; 804A 8E 46 80                 .F.
	sta     L8045                           ; 804D 8D 45 80                 .E.
	lda     #$27                            ; 8050 A9 27                    .'
	cmp     L8045                           ; 8052 CD 45 80                 .E.
	bcc     L805A                           ; 8055 90 03                    ..
	jmp     L805B                           ; 8057 4C 5B 80                 L[.
...
L805B:  lda     #$17                            ; 805B A9 17                    ..
	...
	bcc     L8065                           ; 8060 90 03                    ..
	jmp     L8066                           ; 8062 4C 66 80                 Lf.

; ----------------------------------------------------------------------------
L8065:  rts                                     ; 8065 60                       `

; ----------------------------------------------------------------------------
L8066:  lda     L8045                           ; 8066 AD 45 80                 .E.
	sta     L4751                           ; 8069 8D 51 47                 .QG
	lda     L8046                           ; 806C AD 46 80                 .F.
	sta     L4752                           ; 806F 8D 52 47                 .RG
	...
	clc                                     ; 8079 18                       .
	lda     $AE                             ; 807A A5 AE                    ..
	adc     L4753                           ; 807C 6D 53 47                 mSG
	sta     $AC                             ; 807F 85 AC                    ..
	clc                                     ; 8081 18                       .
	lda     $AC                             ; 8082 A5 AC                    ..
	adc     #$30                            ; 8084 69 30                    i0
	sta     L8045                           ; 8086 8D 45 80                 .E.
...
L836C:  lda     #$0F                            ; 836C A9 0F                    ..
	jsr     L4BA7                           ; 836E 20 A7 4B                  .K
L8371:  lda     L474F                           ; 8371 AD 4F 47                 .OG
	eor     #$03                            ; 8374 49 03                    I.
	beq     L837B                           ; 8376 F0 03                    ..
	jmp     L8386                           ; 8378 4C 86 83                 L..

; ----------------------------------------------------------------------------
L837B:  lda     L81E4                           ; 837B AD E4 81                 ...
	sta     L4762                           ; 837E 8D 62 47                 .bG
	ldy     #$01                            ; 8381 A0 01                    ..
...
; ----------------------------------------------------------------------------
L8398:  lda     #$80                            ; 8398 A9 80                    ..
	cmp     L81DA                           ; 839A CD DA 81                 ...
	bcc     L83A2                           ; 839D 90 03                    ..
	jmp     L83AA                           ; 839F 4C AA 83                 L..

; ----------------------------------------------------------------------------
L83A2:  lda     #$0E                            ; 83A2 A9 0E                    ..
	jsr     L4BA7                           ; 83A4 20 A7 4B                  .K
...
L9352:  lda     #$11                            ; 9352 A9 11                    ..
	jsr     L4BA7                           ; 9354 20 A7 4B                  .K
	lda     #$00                            ; 9357 A9 00                    ..
	sta     $A0                             ; 9359 85 A0                    ..
	rts                                     ; 935B 60                       `

; ----------------------------------------------------------------------------
L935C:  lda     #$01                            ; 935C A9 01                    ..
	sta     $A0                             ; 935E 85 A0                    ..
	rts                                     ; 9360 60                       `
...
L9368:  brk                                     ; 9368 00                       .
	brk                                     ; 9369 00                       .
L936A:  jmp     L936D                           ; 936A 4C 6D 93                 Lm.

; ----------------------------------------------------------------------------
L936D:  ldy     #$00                            ; 936D A0 00                    ..
